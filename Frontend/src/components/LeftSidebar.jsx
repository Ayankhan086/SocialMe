  ...
  return (
    <div className="w-full md:w-64 flex-shrink-0">
      ...
      <div className="bg-white rounded-lg shadow p-2">
        <button onClick={() => handleNav("/home")} className={`flex items-center w-full p-3 rounded-md ${page === " " ? "bg-blue-500 text-white" : "hover:bg-blue-100"} text-left font-medium text-gray-700 `}>
          {/* Home Icon */}
